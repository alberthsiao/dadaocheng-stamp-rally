...
const EVENT = {
  ...
  gacha: {
    ...
    hours: '平日 11:00–18:30／假日 11:00–20:00（週一公休）',
  },
  /** 主辦單位提供的官方連結 */
  links: {
  ...
  rules: [
    '本次活動期間為 7 月 25 日至 8 月 14 日，活動合作店家共 70 家，依紅、橙、黃、綠、藍、靛、紫七種顏色分類，每種顏色各 10 家。',
    '參加者於活動店家完成消費後，可獲得該店家印章一枚；每家店章均有專屬編號，須蓋於 DM 上相同編號的集章格內，編號不符者視為無效。',
    '每次彩虹任務須於七種顏色區域中各集滿 1 枚有效印章，共 7 枚印章，即完成 1 次彩虹任務；完成第 2 次、第 3 次時，各色須再取得不同編號之店家印章，不得重複計算。',
    '每完成 1 次彩虹任務，可至指定活動地點參加 1 次夾扭蛋機活動；每張 DM 最多完成 3 次彩虹任務，並參加 3 次夾扭蛋活動。',
    '活動地點：臺北市大同區民樂街 71 之 1 號旁。平日 11:00–18:30，假日 11:00–20:00（週一公休）。',
    '參加者應於 DM 填寫姓名及手機號碼，作為當次活動參加及重複資格判斷依據。',
    '每人每次限持 1 張 DM 參加，不得同時持多張 DM 重複兌換或代替他人參加；惟隔日重新領取 DM 再參加，則不在此限。',
    '集滿 70 家活動店家有效印章者，可投入摸彩箱參加 8 月 15 日直播大獎摸彩；若發現同一參加者重複投入或重複中獎，僅保留 1 份資格，其餘資格無效，並抽出下一位遞補。',
